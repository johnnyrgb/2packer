...
class Coder:
    ...
    def __encode(self, freqs=None, code=""):
        """
        Приватная рекурсивная функция, которая строит словарь кодов и дерево кодов на основе словаря частот
        :param freqs: словарь частот
        :param code: код текущего символа
        :return:
        """
